...
if __name__ == '__main__':
    for j in (1, 26,38):
        ...
        Xtest1, Xtest2, Xtest3,Xtest4, Xtest5, Xtest6,Xtest7, Xtest8, Xtest9,Xtest10, Xtest11, Xtest12 = Sep12Data(emg_test)
        Y_test = nf.get_categorical(label_test)
        model = keras.models.load_model('D:/Pengxiangdong/ZX/DB2/DB2_model/DB2_s' + str(j) + 'testmodel.h5')
        ...
        with open(root_data+"result/stimulus/111/DB2_s"+str(j)+"testseg.txt", "w", encoding='utf-8') as f:
