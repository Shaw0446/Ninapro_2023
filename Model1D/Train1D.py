...
if __name__ == '__main__':
    for j in (1, 26, 38):
        ...
        Xtrain1, Xtrain2, Xtrain3,Xtrain4, Xtrain5, Xtrain6,Xtrain7, Xtrain8, Xtrain9,Xtrain10, Xtrain11, Xtrain12 = Sep12Data(emg_train)
        Xvali1, Xvali2, Xvali3,Xvali4, Xvali5, Xvali6,Xvali7, Xvali8, Xvali9,Xvali10, Xvali11, Xvali12 = Sep12Data(emg_vali)
        file.close()
        ...
        callbacks = [#1设置学习率衰减,2保存最优模型
            ...
            #                   cooldown=0, min_lr=0),
            ModelCheckpoint(filepath='D:/Pengxiangdong/ZX/DB2/DB2_model/DB2_s' + str(j) + 'testmodel.h5'
            , monitor='val_accuracy', save_best_only=True)]
        model =Away3reluBNCBAMcatNEW()
        model.summary()
        history = model.fit([Xtrain1, Xtrain2, Xtrain3,Xtrain4, Xtrain5, Xtrain6,Xtrain7, Xtrain8, Xtrain9,Xtrain10, Xtrain11, Xtrain12], Y_train, epochs=50, verbose=2, batch_size=64
                            , validation_data=([Xvali1, Xvali2, Xvali3,Xvali4, Xvali5, Xvali6,Xvali7, Xvali8, Xvali9,Xvali10, Xvali11, Xvali12], Y_vail), callbacks=callbacks)
